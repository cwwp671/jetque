...
class MainWindow(QGraphicsView):
    ...
    def add_label(self, text):
        """Add an additional animation_object to the scene."""
        ...
        # Position the animation_object at a predefined location
        label.setPos(50, 50)  # Example position
        logging.debug(f"Added animation_object with text: {text}")
...
def main():
    ...
    # Example: Add an additional animation_object (optional)
